    ...
    setState(() {
      ...
      _error = bleService.lastError.isNotEmpty
          ...
          : 'Pairing was cancelled or the code did not match. Check the number '
              'on your KeyGuard and try again.';
    });
  }
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Your KeyGuard is showing a six-digit code on its screen.',
            ...
            Text(
              bleService.supportsBonding
                  ...
                  : 'iOS handles Bluetooth pairing itself. When the code appears '
                      'on your KeyGuard, enter it in the system prompt that '
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 6),
          Text('on your KeyGuard\'s screen',
